...
Usage ``polls_demo [OPTIONS] COMMAND [ARGS]...``

Example command 'welcome' has been added.
- To get your project version, run ``polls_demo --version``
- Run the sample command as ``polls_demo welcome [OPTIONS] NAME``
"""

from polls_demo import __version__
import click
...
def welcome(name, verbose):
    ...
    """
    click.secho(f"Hi {name}. Welcome to polls_demo", fg="cyan")
