...
from shopyo.api.models import PkModel, TimestampMixin, SoftDeleteMixin, SearchMixin, PaginationMixin
from init import db

class ModelForTesting(PkModel, TimestampMixin, SoftDeleteMixin, SearchMixin, PaginationMixin):
