...
def test_get_self_static_box(mock_get_static, tmp_path):
    ...
    mock_get_static.assert_called_with(boxormodule="box__box1/mod1", filename="script.js")
...
def test_redirect_url(fake_module):
    ...
    with app.test_request_context():
        with patch('shopyo.api.module.redirect') as mock_redirect, \
             patch('shopyo.api.module.url_for') as mock_url_for:
